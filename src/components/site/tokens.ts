...
export const FIELD =
  ...
  "placeholder:text-site-faint focus:border-premium_pink/60 focus:bg-site-raised focus:shadow-[0_0_0_3px_var(--site-accent-ring)]";
...
export const BTN_PRIMARY =
  ...
  "hover:bg-premium_pink_hover active:translate-y-px disabled:cursor-not-allowed disabled:opacity-55 disabled:hover:bg-premium_pink";
